...
class FluroRouter{
  ...
  var addTitleHandler=Handler(handlerFunc: (BuildContext, Map<String, dynamic> param){
    return AddTitle();
  });
  var pickDateHandler=Handler(handlerFunc: (BuildContext, Map<String, dynamic> params){
